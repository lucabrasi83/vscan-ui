...
// export { ProductsService } from './products.service.fake'; // You have to comment this, when your real back-end is
// done
...
export { ProductRemarksService } from "./product-remarks.service"; // You have to uncomment this, when your real
// back-end is done
...
export { ProductSpecificationsService } from "./product-specifications.service"; // You have to uncomment this, when
// your real back-end is done
