...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		self: {
			...
			logo: {
				dark: "./assets/media/logos/vscan-logo.png",
				light: "./assets/media/logos/vscan-logo.png",
				brand: "./assets/media/logos/vscan-logo.png",
				green: "./assets/media/logos/vscan-logo.png"
			}
		},
